...
regressor_non_noisy = DecisionTreeRegressor(max_depth=5)
regressor_noisy = DecisionTreeRegressor(max_depth=5)
...
ax_noise.set_title('Decision Tree Noisy Data')
ax_noise.legend(loc='lower left')

ax_non_noise.set_xlabel('Data')
ax_non_noise.set_ylabel('Target')
ax_non_noise.set_title('Decision Tree Normal Data')
...
fig.savefig('Plot\\DT.jpg',dpi=fig.dpi)
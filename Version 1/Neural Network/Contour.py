    ...
    for model in model_list:
        ...
        for randomize in randomize_list:
            ...
            if model == 'DEC':
                ...
                fig.suptitle(f'Noise Effect {tuning[0]+tuning[1:].lower()} {model} Model ({randomize[0]+randomize[1:].lower()})')
            ...
            for key,value in concat_df_dict.items():
                ...
                for seed in seed_list:
                    ...
                    df = pd.read_csv(f'{randomize}\\MODEL{model}RANDOMIZE{randomize}NOISE{concat_count}SEED{seed}{tuning}.csv')
            ...
            all_dataset_zmax = 924.8277904934974
            all_dataset_zmin = 0      
            ...
            fig.savefig(f'Plot\\{model}{randomize}{tuning}.jpg',dpi=fig.dpi)

...
class Process:
    ...
    def process(self):
        ...
        for random_seed in range(10):
            ...
            self.combined_df = pd.DataFrame(columns=[f'NOISEPERCENTSEED{self.random_seed}',f'MAESEED{self.random_seed}',f'MSESEED{self.random_seed}',f'RMSESEED{self.random_seed}',f'R2SEED{self.random_seed}',f'MAPESEED{self.random_seed}',f'TIMESEED{self.random_seed}'])
    ...
    def append_to_dataframe(self):
        ...
        self.temp_df = pd.DataFrame([[self.randomize_value,self.MAE,self.MSE,self.RMSE,self.R2,self.MAPE,(self.train_end_time-self.train_start_time)/60]],columns=[f'NOISEPERCENTSEED{self.random_seed}',f'MAESEED{self.random_seed}',f'MSESEED{self.random_seed}',f'RMSESEED{self.random_seed}',f'R2SEED{self.random_seed}',f'MAPESEED{self.random_seed}',f'TIMESEED{self.random_seed}'])
